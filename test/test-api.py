...
def enabled_branches(branch_id):
    ...
    obj['link']['href'] = "https://bamboo-master.server.com/rest/api/latest/plan/{}/branch".format(branch_id)
    return obj
...
def build_plan(branch_id):
    ...
    obj['link']['href'] = "https://bamboo-master.server.com/rest/api/latest/plan/{}".format(branch_id)
    return obj
